...
- **docker-compose.yml**: recommended baseline for a normal install (Sentinel only by default; optional Tailscale + keepalived/HA blocks are commented and ready to enable).
