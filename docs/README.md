...
This folder contains short, focused guides.
If you are installing Sentinel-DNS for the first time, start with the root README.
...
- **Development setup & test pyramid:** [DEVELOPMENT.md](DEVELOPMENT.md)
